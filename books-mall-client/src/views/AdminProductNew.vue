<template>
  <div>
    <a-form :form="form" @submit="handleSubmit">
      <a-form-item v-bind="formItemLayout" label="书籍标题" has-feedback>
        <a-input
          v-decorator="[
          'name',
          {
      ...
      <a-form-item v-bind="formItemLayout" label="书籍单价">
        <a-input-number
          :min="0"
      ...
      <a-form-item v-bind="formItemLayout" label="书籍库存">
        <a-input-number
          :min="0"
          :step="1"
          v-decorator="[
      ...
      <a-form-item v-bind="formItemLayout" label="推荐书籍">
        <a-checkbox
          v-decorator="[
          'recommended',
          {
      ...
      <a-form-item v-bind="formItemLayout" label="书籍分类" has-feedback>
        <a-select
          v-decorator="[
          'commodityTypeId',
      ...
      <a-form-item v-bind="formItemLayout" label="书籍主图URL" has-feedback>
        <a-input
          v-decorator="[
          'imgMain',
          {
      ...
      <a-form-item v-bind="formItemLayout" label="书籍介绍">
        <a-textarea
          v-decorator="[
          'detail',
          {
        ...
        Get(API.commodityType.all)
          ...
          .do(response => {
            ...
            if (this.productType.length === 0) {
              this.$message.error("请添加书籍分类后再添加书籍！");
